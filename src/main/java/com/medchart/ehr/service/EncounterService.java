...
public class EncounterService {
    ...
    @AuditAccess(action = AuditAction.READ, resourceType = "Encounter", description = "Find encounter by ID")
    @Transactional(readOnly = true)
    public Optional<Encounter> findById(Long id) {
        return encounterRepository.findById(id);
    }

    @AuditAccess(action = AuditAction.READ, resourceType = "Encounter", description = "Find encounter by ID with details")
    @Transactional(readOnly = true)
    public Optional<Encounter> findByIdWithDetails(Long id) {
        return encounterRepository.findByIdWithDetails(id);
    }

    @AuditAccess(action = AuditAction.READ, resourceType = "Encounter", description = "Find encounter by number")
    @Transactional(readOnly = true)
    ...
    @AuditAccess(action = AuditAction.READ, resourceType = "Encounter", description = "Find encounters by patient ID")
    @Transactional(readOnly = true)
    public List<Encounter> findByPatientId(Long patientId) {
        return encounterRepository.findByPatientId(patientId);
    }

    @AuditAccess(action = AuditAction.READ, resourceType = "Encounter", description = "Find encounters by patient ID (paged)")
    @Transactional(readOnly = true)
    ...
    @AuditAccess(action = AuditAction.READ, resourceType = "Encounter", description = "Find encounters by provider ID")
    @Transactional(readOnly = true)
    public List<Encounter> findByProviderId(Long providerId) {
        return encounterRepository.findByAttendingProviderId(providerId);
    }

    @AuditAccess(action = AuditAction.READ, resourceType = "Encounter", description = "Get provider schedule")
    @Transactional(readOnly = true)
    ...
    @AuditAccess(action = AuditAction.SEARCH, resourceType = "Encounter", description = "Find encounters by date range")
    @Transactional(readOnly = true)
    ...
    @AuditAccess(action = AuditAction.SEARCH, resourceType = "Encounter", description = "Find encounters by status")
    @Transactional(readOnly = true)
    ...
    @AuditAccess(action = AuditAction.UPDATE, resourceType = "Encounter", description = "Check in patient for encounter")
