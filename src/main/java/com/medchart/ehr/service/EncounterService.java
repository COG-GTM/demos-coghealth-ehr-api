...
public class EncounterService {
    ...
    @AuditAccess(action = AuditAction.READ, resourceType = "Encounter", description = "View encounter",
    ...
    @Transactional(readOnly = true)
    @AuditAccess(action = AuditAction.READ, resourceType = "Encounter", description = "View encounter details",
            patientIdArg = AuditAccess.NONE, resourceIdArg = 0)
    ...
    @Transactional(readOnly = true)
    @AuditAccess(action = AuditAction.READ, resourceType = "Encounter", description = "View patient encounter history",
            patientIdArg = 0)
    ...
    @Transactional(readOnly = true)
    @AuditAccess(action = AuditAction.SEARCH, resourceType = "Encounter", description = "List provider encounters",
            patientIdArg = AuditAccess.NONE)
    ...
    @Transactional(readOnly = true)
    @AuditAccess(action = AuditAction.SEARCH, resourceType = "Encounter", description = "View provider schedule",
            patientIdArg = AuditAccess.NONE)
    ...
    @Transactional(readOnly = true)
    @AuditAccess(action = AuditAction.READ, resourceType = "Encounter", description = "Count patient encounters",
            patientIdArg = 0)
