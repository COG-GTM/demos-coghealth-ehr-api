...
public class LegacyPatientLookup {
    ...
    @AuditAccess(action = AuditAction.READ, resourceType = "Patient", description = "Legacy patient lookup by MRN")
    ...
    @AuditAccess(action = AuditAction.SEARCH, resourceType = "Patient", description = "Legacy patient search by last name")
    ...
    @AuditAccess(action = AuditAction.READ, resourceType = "Patient", description = "Legacy patient demographics lookup")
